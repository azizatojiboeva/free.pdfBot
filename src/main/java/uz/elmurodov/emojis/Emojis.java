...
public class Emojis {
    ...
    public static final String MY_BOOKS = "\uD83D\uDCDA ";
    public static final String ADD = "\u2795";
    public static final String SETTINGS1 = "\uD83D\uDEE0";
    public static final String SETTINGS = "\u2699";
    public static final String right = "\u27A1\uFE0F";
    public static final String left = "\u2B05\uFE0F";
    public static final String MALE = "\uD83D\uDC68\u200D\uD83E\uDDB3";
    public static final String FEMALE = "\uD83D\uDC69\u200D\uD83E\uDDB0";
    public static final String SCIENCE = "\u267B\uFE0F";
    public static final String ADVENTURE = "\uD83D\uDCA0";
    public static final String HISTORY = "\u23F3";
    public static final String ROMANCE = "\u2764\uFE0F";
    public static final String FANTASY = "\u231B\uFE0F";
